...
The result of a `wkt_coords` call is a list of data.frames - one for every WKT polygon you pass in - each containing
a data.frame of `lon` and `lat` coordinates for each point within the polygon.
